...
const I18N_UI = {
  it: {
    ...
    "notif.letturaInCorso": "🔍 Lettura del documento in corso...",
    "notif.letturaRiuscita": "Campi compilati dal documento: {campi}. Controllali prima di proseguire.",
    "notif.letturaRiuscitaBreve": "✅ Dati letti dal documento: controllali",
    "notif.letturaFallita": "Non sono riuscito a leggere il documento: compila i campi a mano.",
    "notif.letturaPdf": "Dal PDF non riesco a leggere i dati: compila i campi a mano.",
    "notif.letturaNonDisponibile": "Lettura automatica non disponibile: compila i campi a mano.",
    ...
    "valid.documentoScanMancante": "Carica la foto del documento dell'ospite {n}",
    ...
    "guest.documentoSottotitolo": "Servono due file: il fronte e il retro del documento (foto o PDF). Con il passaporto basta la pagina con i dati. Questi file vengono inviati al proprietario insieme alla registrazione.",
    ...
    "guest.latoScan": "Foto del documento",
    "guest.latoScanHint": "Carta d'identità: il retro. Passaporto: la pagina con la foto.",
    "guest.documentoSottotitoloScan": "Fotografa il lato del documento con le righe di codice: i campi qui sotto si compilano da soli. La foto resta sul tuo telefono e non viene inviata.",
  ...
  en: {
    ...
    "notif.letturaInCorso": "🔍 Reading the document...",
    "notif.letturaRiuscita": "Fields filled in from the document: {campi}. Please check them before continuing.",
    "notif.letturaRiuscitaBreve": "✅ Data read from the document: please check it",
    "notif.letturaFallita": "I couldn't read the document: please fill in the fields manually.",
    "notif.letturaPdf": "I can't read the data from a PDF: please fill in the fields manually.",
    "notif.letturaNonDisponibile": "Automatic reading is unavailable: please fill in the fields manually.",
    ...
    "valid.documentoScanMancante": "Upload the photo of guest {n}'s document",
    ...
    "guest.documentoSottotitolo": "Two files are required: the front and the back of the document (photo or PDF). For a passport, the data page is enough. These files are sent to the owner together with the registration.",
    ...
    "guest.latoScan": "Photo of the document",
    "guest.latoScanHint": "ID card: the back. Passport: the photo page.",
    "guest.documentoSottotitoloScan": "Photograph the side of the document with the lines of code: the fields below fill in by themselves. The photo stays on your phone and is not sent anywhere.",
  ...
  de: {
    ...
    "notif.letturaInCorso": "🔍 Dokument wird gelesen...",
    "notif.letturaRiuscita": "Aus dem Dokument übernommene Felder: {campi}. Bitte vor dem Fortfahren prüfen.",
    "notif.letturaRiuscitaBreve": "✅ Daten aus dem Dokument gelesen: bitte prüfen",
    "notif.letturaFallita": "Das Dokument konnte nicht gelesen werden: bitte die Felder manuell ausfüllen.",
    "notif.letturaPdf": "Aus einem PDF können die Daten nicht gelesen werden: bitte manuell ausfüllen.",
    "notif.letturaNonDisponibile": "Automatisches Lesen nicht verfügbar: bitte die Felder manuell ausfüllen.",
    ...
    "valid.documentoScanMancante": "Laden Sie das Foto des Dokuments von Gast {n} hoch",
    ...
    "guest.documentoSottotitolo": "Es werden zwei Dateien benötigt: die Vorderseite und die Rückseite des Dokuments (Foto oder PDF). Beim Reisepass genügt die Datenseite. Diese Dateien werden zusammen mit der Anmeldung an den Eigentümer gesendet.",
    ...
    "guest.latoScan": "Foto des Dokuments",
    "guest.latoScanHint": "Personalausweis: die Rückseite. Reisepass: die Seite mit dem Foto.",
    "guest.documentoSottotitoloScan": "Fotografieren Sie die Seite mit den Codezeilen: die Felder unten werden automatisch ausgefüllt. Das Foto bleibt auf Ihrem Telefon und wird nicht übermittelt.",
    "guest.facoltativo": "Optional",
